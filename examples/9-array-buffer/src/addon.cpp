...
static Napi::Value AcceptArrayBuffer(const Napi::CallbackInfo &info) {
    ...
    ArrayConsumer(reinterpret_cast<const int32_t *>(buf.Data()), buf.ByteLength() / sizeof(int32_t));
    return info.Env().Undefined();
}

static Napi::Object Init(Napi::Env env, Napi::Object exports) {
    exports.Set("AcceptArrayBuffer", Napi::Function::New(env, AcceptArrayBuffer));
    return exports;
}
